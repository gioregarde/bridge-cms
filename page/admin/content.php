<form action="<?php echo Properties::getUrlRoot(true); ?>/admin/content" method="post">
    ...
    <label>
        <a class="button" href="<?php echo Properties::getUrlRoot(true); ?>/admin/content/add">Add</a>
