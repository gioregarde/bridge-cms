<form action="<?php echo Properties::getUrlRoot(true); ?>/admin/navigation" method="post">
    ...
    <label>
        <a class="button" href="<?php echo Properties::getUrlRoot(true); ?>/admin/navigation/add">Add</a>
