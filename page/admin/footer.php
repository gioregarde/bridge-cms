<form action="<?php echo Properties::getUrlRoot(true); ?>/admin/footer" method="post">
    ...
    <label>
        <a class="button" href="<?php echo Properties::getUrlRoot(true); ?>/admin/footer/add">Add</a>
