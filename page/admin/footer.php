<div class="container-fluid top-section">
    ...
    <div class="row">
        <div class="col-sm-offset-1 col-sm-10">
            <form class="form-horizontal" action="<?php echo Properties::getUrlRoot(true); ?>/admin/footer" method="post">
                        ...
                        <tbody>
                            <?php foreach ($dto_array as $dto) { ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo Properties::getUrlRoot(true); ?>/admin/footer/edit?id=<?php echo $dto -> getId(); ?>"><?php echo $dto -> getName(); ?></a></td>
                ...
                <a class="btn btn-default col-sm-offset-3 col-sm-2" href="<?php echo Properties::getUrlRoot(true); ?>/admin/footer/add">Add</a>
