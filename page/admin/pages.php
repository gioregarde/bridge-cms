<div class="container-fluid top-section">
    ...
    <div class="row">
        <div class="col-sm-offset-1 col-sm-10">
            <form class="form-horizontal" action="<?php echo Properties::getUrlRoot(true); ?>/admin/pages" method="post">
                ...
                <a class="btn btn-default col-sm-offset-3 col-sm-2" href="<?php echo Properties::getUrlRoot(true); ?>/admin/page/add">Add</a>
