<form action="<?php echo Properties::getUrlRoot(true); ?>/admin/header" method="post">
    ...
    <label>
        <a class="button" href="<?php echo Properties::getUrlRoot(true); ?>/admin/header/add">Add</a>
